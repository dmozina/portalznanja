...
#This is custom video web service called from featured video web service. It returns the following columns from the
#Video table.
...
#Featured video web service that returns the videos that are currently marked as featured.
