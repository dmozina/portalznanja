...
#Comment model represent single entity of feedback posted by user. The comment is linked to a video and owner.
...
#Video model represent one video uploaded and/or found by internal parser on the selected sites.
#A video is a lone standing entity and is aways displayed with its comments on the /video subpage.
